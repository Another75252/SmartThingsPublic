/*  EchoSistant Simulated Presence Sensor 
 *
 * Taken from Infofiend's GitHub which was Taken from SmartThings base code, enhanced and bugfixed by RBoy
 *
 * All work for this DTH code is credited to Tony @Infofiend.  Modifications performed by @BamaRayne to make
 * the code compatible with EchoSistant.
 */
metadata {
	// Automatically generated. Make future change here.
	definition (name: "EchoSistant Simulated Presence Sensor", namespace: "EchoSistant", author: "smartthings") {
